...
$(function(){
	...
	var tail = "<div class='time'>"+ new Date().toLocaleString()+"</div></div> </div></div>";
...
$.post("/",data,function(res,err){
	...
	if (err !== "success"){
		...
		$(receivedHeadError+"Can you please say that again"+tail).hide().appendTo(".chatdiv").show("puff", {times : 3}, 200);
